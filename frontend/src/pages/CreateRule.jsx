    ...
    "days_supply_field": "days_supply"
          ...
          <div className="flex justify-end gap-3">
            ...
            <button
              type="submit"
              disabled={saving}
              className="flex items-center gap-2 px-3 py-1 bg-primary text-white rounded-lg hover:bg-primary-hover transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
